...
//                    Bitmap bitmap = BitmapFactory.decodeResource(res, R.drawable.bg_btn_nor);
//
//                    Bitmap bitmap_blur = blurBitmap(bitmap);
//                    Drawable drawable_blur = new BitmapDrawable(bitmap_blur);
//                    holder.cbSelected.setBackground(drawable_blur);
//                    holder.cbSelected.getBackground().setAlpha(10);
